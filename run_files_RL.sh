...
# code repo in home
export CODE_ROOT="$HOME/projects/Mapping_Behav_RL"

# data/output on RDS
export DATA_ROOT="/rds/projects/z/zhanglp-vwendler-core/ABM_Mapping/Mapping_landscape_RL"

cd "$CODE_ROOT"
Rscript "$DATA_ROOT/2_code/4_clustering.R"
